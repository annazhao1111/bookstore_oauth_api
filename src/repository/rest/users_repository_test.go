...
// the entry point of every test is TestMain(m *testing.M) function
...
func TestLoginUserInvalidUserJsonResponse(t *testing.T) {
	...
	rest.AddMockups(&rest.Mock{
		...
		RespBody:     `{"id": "1", "first_name": "Anna", "last_name": "Zhao", "email": "anna.zhao871111@gmail.com"}`,
	})
	repository := usersRepository{}
	user, err := repository.LoginUser("email@gmail.com", "the-password")
...
func TestLoginUserNoError(t *testing.T) {
	...
	assert.EqualValues(t, "Anna", user.FirstName)
	assert.EqualValues(t, "Zhao", user.LastName)
	assert.EqualValues(t, "anna.zhao871111@gmail.com", user.Email)
}
